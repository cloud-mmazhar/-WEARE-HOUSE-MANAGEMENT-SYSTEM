                            ...
                            <asp:Panel ID="pnlPhone" Wrap="true" runat="server" Visible="false" Width="440px"
                                ...
                                <table style="width: 89%">
                                    ...
                                    <tr class="NormalTextStyle">
                                        ...
                                        <td class="style3">
                                            <asp:ImageButton ID="imgbtnphoneSubmit" runat="server" CausesValidation="true" ImageUrl="~/Images/btn_submit.jpg"
                                                OnClick="imgbtnphoneSubmit_Click" ValidationGroup="add" />&nbsp;&nbsp;
                                            <asp:ImageButton ID="imgbtnPhoneClose" runat="server" ImageUrl="~/Images/btn_Close.jpg"

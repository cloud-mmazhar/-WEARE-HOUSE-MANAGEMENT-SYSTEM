<%@ Control Language="C#" AutoEventWireup="true" CodeFile="UserRegistrationCotrol.ascx.cs" Inherits="UserControls_RegistrationCotrol" %>
<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="cc2" %>
<%@ Register TagName="ImageBroser" Src="~/User_UserControls/BrowseImage.ascx" TagPrefix="UcBI" %>
...
<fieldset style="border:1px;border-color:#FF9A31;border-width:thick" >
<br />
<div class="style14">

<%@ Page Language="C#" MasterPageFile="~/Admin/AdminMasterPage.master" AutoEventWireup="true" CodeFile="frmAddStorageInstMaster.aspx.cs" Inherits="Admin_frmAddStorageInstMaster" Title="Untitled Page" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <center>
        <br />
        <div style="width: 418px" class="style9">
            Add New Storage Instruction  
        </div>
        <br />
        ...
        <br />
        <div style="overflow: auto; width: 422px;" runat="server" id="divStorageInst" height="500px"
            visible="false">
            <asp:GridView ID="grdStorageInst" runat="server" CellPadding="4" ForeColor="#333333"

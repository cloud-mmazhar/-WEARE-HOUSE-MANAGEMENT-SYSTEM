<%@ Page Language="C#" MasterPageFile="~/Admin/AdminMasterPage.master" AutoEventWireup="true" CodeFile="frmAddDept.aspx.cs" Inherits="Admin_ManageEmp_frmAddDept" Title="Untitled Page" %>
...
<br />
<br />
        <span class="style3">Add Department Information Here</span><br />
    <br />
    <center>
        ...
        <tr>
            ...
            <td style="text-align: left">
                <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" 
                    ErrorMessage="Enter Location" ControlToValidate="TextBox3"></asp:RequiredFieldValidator>
            </td>
        </tr>
        <tr>
            <td>

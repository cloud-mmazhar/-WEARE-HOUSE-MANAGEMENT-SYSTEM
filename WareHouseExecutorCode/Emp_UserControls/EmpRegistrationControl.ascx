...
<%@ Register TagPrefix="UcBI" TagName="ImageBroser" Src="~/Emp_UserControls/BrowseImage.ascx"  %>
...
<asp:UpdatePanel ID="MainUp" runat="server">
    ...
    <ContentTemplate>
        <center style="height: 349px; width: 765px; background-image: url('../Images/tableInnerback.JPG');
            background-repeat: repeat-x; border: 2px solid #90DA9F;">
            <asp:Label ID="lblTitle" runat="server" Font-Bold="True" Font-Size="Larger" ForeColor="Black"></asp:Label>
            ...
            <fieldset style="border-style: none; border-color: inherit; border-width: 0; width: 700px;">
                <legend style="font-family: Verdana; width: 770px; background-image: url('Images/linkbg.gif');
                    font-size: 15px; font-weight: bold; background-color: #B4DFAA;" class="style99">
                    1. Personal Details...</legend>
                <br />
                <br />
                <center>
                    <table style="border: 1px dashed #00CC99; width: 779px; height: 160px; font-family: Verdana;
                        font-size: 10px;">
                        <tr>
                            <td class="styles6">
                            </td>
                            ...
                            <td align="left" valign="top" colspan="3" rowspan="5">
                                <UcBI:ImageBroser UpdateMode="Conditional" ID="EmpPhoto" runat="server" DefaultImageUrl="~/Images/NoImage.jpg" />
                            </td>
                        </tr>
                        <tr>
                            <td class="styles6">
                        ...
                        <tr>
                            ...
                            <td class="styles7">
                                First Designation<span class="styles10">*</span>
                            </td>
                            <td align="left">
                                <%--<asp:UpdatePanel runat="server" ID="UpdatePanel0" >
                
                <ContentTemplate >--%>
                                <asp:DropDownList ID="ddlDesg" runat="server" AutoPostBack="false" Height="18px"
                                    Width="105px">
                                </asp:DropDownList>
                        ...
                        <tr>
                            ...
                            <td align="left" class="styles13">
                                <asp:DropDownList ID="ddlDept" runat="server" Height="16px" Width="105px" 
                                    AutoPostBack="false">
                                    <asp:ListItem Value="--Select One--">--Select One--</asp:ListItem>
                                </asp:DropDownList>
                            </td>
                         ...
                         <tr>
                            ...
                            <td class="styles7">
                                Employee Role <span class="styles10">*</span>
                            </td>
                            <td align="left" class="styles13">
                                <asp:DropDownList ID="ddlRole" runat="server" Height="16px" Width="105px" 
                                    AutoPostBack="false">
                                    <asp:ListItem Value="--Select One--">--Select One--</asp:ListItem>
                            ...
                            <td align="left" class="styles13">
                                <asp:RequiredFieldValidator InitialValue="--Select One--" ID="RequiredFieldValidator4"
                                    ControlToValidate="ddlDept" runat="server" ErrorMessage="*"></asp:RequiredFieldValidator>
                            </td>
                            <td style="text-align: right" class="style96">
                            </td>
                        ...
                        <tr>
                            ...
                            <td align="left" class="styles18">
                                <asp:DropDownList ID="ddlQualification" runat="server" Height="16px" Width="105px">
            ...
            <fieldset style="border-style: none; border-color: inherit; border-width: 0; width: 700px;
                ...
                <legend style="width: 770px; background-image: url('Images/linkbg.gif'); font-family: Verdana;
                    font-size: 15px; font-weight: bold; background-color: #C2EDB8;" class="style99">
                    2.Mailing & Contact Details</legend>
                <br />
                <br />
                <center>
                    <table style="border: 1px dashed #00CC99; width: 775px; font-size: 10px; height: 344px;
                        font-family: Verdana;">
                        <tr>
                            <td class="style86">
                            </td>
                        ...
                        <tr>
                            ...
                            <td colspan="7">
                                <asp:Label BackColor="Yellow" ID="lblAddressMsg" runat="server"></asp:Label>
                            </td>
                        </tr>
                        <tr>
            ...
            <fieldset style="border-style: none; border-width: 0; width: 700px; background-image: url('../../Images/newbackground.jpg');">
                <legend style="width: 770px; background-image: url('Images/linkbg.gif'); font-family: Verdana;
                    font-size: 15px; font-weight: bold; background-color: #B7E2AC;" class="style99">
                    3.Account Details</legend>
                <br />
                <br />
                <center>
                    <table style="border: 1px dashed #00CC99; width: 775px; font-size: 10px; font-family: verdana;">
                        <tr>
                            <td class="style86">
                            </td>
                            <td align="left" class="style77">
